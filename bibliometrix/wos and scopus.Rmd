...
DW <- ("bibliometrix\\bib_data\\AI sustainability (wos).bib")
DS <- ("bibliometrix\\bib_data\\AI sustainability (scopus).bib")

#Step 2: The object D can be converted in a data frame using the function convert2df
MW <- convert2df(DW, dbsource = "wos", format = "bibtex")
...
write.csv(M, "bibliometrix\\bib_data\\merged.csv")

library(tidyverse)
write_rds(M, "bibliometrix\\bib_data\\merged.rds")
